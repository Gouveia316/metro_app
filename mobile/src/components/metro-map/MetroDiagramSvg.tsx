...
const LINE_STATUS_STYLES: Record<MetroLineStatus, { opacity: number }> = {
  normal: { opacity: 1 },
  disrupted: { opacity: 0.82 },
  interrupted: { opacity: 0.62 },
  closed: { opacity: 0.85 },
  unknown: { opacity: 0.85 },
};

const WARNING_MARKER_STYLES: Record<"disrupted" | "interrupted", { fill: string }> = {
  disrupted: { fill: "#F59E0B" },
  interrupted: { fill: "#EF4444" },
};

const STATUS_BADGE_STATIONS: Record<MetroLineId, string[]> = {
  blue: [
    "reboleira",
    "amadora-este",
    "alfornelos",
  ...
  const renderStationDot = ({
    ...
    stationId: string;
      ...
      if (
        ...
        !STATUS_BADGE_STATIONS[lineId].includes(stationId)
      ) {
        return <Path id={stationId} d={d} fill="white" stroke="white" strokeWidth={2} />;
      }

      const marker = WARNING_MARKER_STYLES[status];

      return (
        <G id={stationId}>
          <Circle cx={cx} cy={cy} fill={marker.fill} r={6.5} stroke="white" strokeWidth={2} />
          <SvgText
      ...
      <G id="metro-lines-official-position-starter 1">
        ...
        {showStationDots ? (
          <>
            ...
            <G id="station-dots">
          {renderStationDot({ cx: 145, cy: 220, d: "M145 224C147.209 224 149 222.209 149 220C149 217.791 147.209 216 145 216C142.791 216 141 217.791 141 220C141 222.209 142.791 224 145 224Z", lineId: "blue", stationId: "reboleira" })}
          {renderStationDot({ cx: 182, cy: 219, d: "M182 223C184.209 223 186 221.209 186 219C186 216.791 184.209 215 182 215C179.791 215 178 216.791 178 219C178 221.209 179.791 223 182 223Z", lineId: "blue", stationId: "amadora-este" })}
          {renderStationDot({ cx: 216, cy: 219, d: "M216 223C218.209 223 220 221.209 220 219C220 216.791 218.209 215 216 215C213.791 215 212 216.791 212 219C212 221.209 213.791 223 216 223Z", lineId: "blue", stationId: "alfornelos" })}
          {renderStationDot({ cx: 255, cy: 220, d: "M255 224C257.209 224 259 222.209 259 220C259 217.791 257.209 216 255 216C252.791 216 251 217.791 251 220C251 222.209 252.791 224 255 224Z", lineId: "blue", stationId: "pontinha" })}
          {renderStationDot({ cx: 288, cy: 253, d: "M288 257C290.209 257 292 255.209 292 253C292 250.791 290.209 249 288 249C285.791 249 284 250.791 284 253C284 255.209 285.791 257 288 257Z", lineId: "blue", stationId: "carnide" })}
          {renderStationDot({ cx: 322, cy: 286, d: "M322 290C324.209 290 326 288.209 326 286C326 283.791 324.209 282 322 282C319.791 282 318 283.791 318 286C318 288.209 319.791 290 322 290Z", lineId: "blue", stationId: "colegio-militar" })}
          {renderStationDot({ cx: 354, cy: 318, d: "M354 322C356.209 322 358 320.209 358 318C358 315.791 356.209 314 354 314C351.791 314 350 315.791 350 318C350 320.209 351.791 322 354 322Z", lineId: "blue", stationId: "alto-moinhos" })}
          {renderStationDot({ cx: 384, cy: 348, d: "M384 352C386.209 352 388 350.209 388 348C388 345.791 386.209 344 384 344C381.791 344 380 345.791 380 348C380 350.209 381.791 352 384 352Z", lineId: "blue", stationId: "laranjeiras" })}
          {renderStationDot({ cx: 414, cy: 378, d: "M414 382C416.209 382 418 380.209 418 378C418 375.791 416.209 374 414 374C411.791 374 410 375.791 410 378C410 380.209 411.791 382 414 382Z", lineId: "blue", stationId: "jardim-zoologico" })}
          {renderStationDot({ cx: 445, cy: 410, d: "M445 414C447.209 414 449 412.209 449 410C449 407.791 447.209 406 445 406C442.791 406 441 407.791 441 410C441 412.209 442.791 414 445 414Z", lineId: "blue", stationId: "praca-espanha" })}
          {renderStationDot({ cx: 518, cy: 483, d: "M518 487C520.209 487 522 485.209 522 483C522 480.791 520.209 479 518 479C515.791 479 514 480.791 514 483C514 485.209 515.791 487 518 487Z", lineId: "blue", stationId: "parque" })}
          {renderStationDot({ cx: 595, cy: 559, d: "M595 563C597.209 563 599 561.209 599 559C599 556.791 597.209 555 595 555C592.791 555 591 556.791 591 559C591 561.209 592.791 563 595 563Z", lineId: "blue", stationId: "avenida" })}
          {renderStationDot({ cx: 632, cy: 596, d: "M632 600C634.209 600 636 598.209 636 596C636 593.791 634.209 592 632 592C629.791 592 628 593.791 628 596C628 598.209 629.791 600 632 600Z", lineId: "blue", stationId: "restauradores" })}
          {renderStationDot({ cx: 726, cy: 630, d: "M726 634C728.209 634 730 632.209 730 630C730 627.791 728.209 626 726 626C723.791 626 722 627.791 722 630C722 632.209 723.791 634 726 634Z", lineId: "blue", stationId: "terreiro-paco" })}
          {renderStationDot({ cx: 804, cy: 630, d: "M804 634C806.209 634 808 632.209 808 630C808 627.791 806.209 626 804 626C801.791 626 800 627.791 800 630C800 632.209 801.791 634 804 634Z", lineId: "blue", stationId: "santa-apolonia" })}
          {renderStationDot({ cx: 579, cy: 117, d: "M579 121C581.209 121 583 119.209 583 117C583 114.791 581.209 113 579 113C576.791 113 575 114.791 575 117C575 119.209 576.791 121 579 121Z", lineId: "yellow", stationId: "odivelas" })}
          {renderStationDot({ cx: 579, cy: 151, d: "M579 155C581.209 155 583 153.209 583 151C583 148.791 581.209 147 579 147C576.791 147 575 148.791 575 151C575 153.209 576.791 155 579 155Z", lineId: "yellow", stationId: "senhor-roubado" })}
          {renderStationDot({ cx: 579, cy: 185, d: "M579 189C581.209 189 583 187.209 583 185C583 182.791 581.209 181 579 181C576.791 181 575 182.791 575 185C575 187.209 576.791 189 579 189Z", lineId: "yellow", stationId: "ameixoeira" })}
          {renderStationDot({ cx: 579, cy: 219, d: "M579 223C581.209 223 583 221.209 583 219C583 216.791 581.209 215 579 215C576.791 215 575 216.791 575 219C575 221.209 576.791 223 579 223Z", lineId: "yellow", stationId: "lumiar" })}
          {renderStationDot({ cx: 579, cy: 253, d: "M579 257C581.209 257 583 255.209 583 253C583 250.791 581.209 249 579 249C576.791 249 575 250.791 575 253C575 255.209 576.791 257 579 257Z", lineId: "yellow", stationId: "quinta-conchas" })}
          {renderStationDot({ cx: 579, cy: 324, d: "M579 328C581.209 328 583 326.209 583 324C583 321.791 581.209 320 579 320C576.791 320 575 321.791 575 324C575 326.209 576.791 328 579 328Z", lineId: "yellow", stationId: "cidade-universitaria" })}
          {renderStationDot({ cx: 579, cy: 364, d: "M579 368C581.209 368 583 366.209 583 364C583 361.791 581.209 360 579 360C576.791 360 575 361.791 575 364C575 366.209 576.791 368 579 368Z", lineId: "yellow", stationId: "entre-campos" })}
          {renderStationDot({ cx: 579, cy: 404, d: "M579 408C581.209 408 583 406.209 583 404C583 401.791 581.209 400 579 400C576.791 400 575 401.791 575 404C575 406.209 576.791 408 579 408Z", lineId: "yellow", stationId: "campo-pequeno" })}
          {renderStationDot({ cx: 572, cy: 484, d: "M572 488C574.209 488 576 486.209 576 484C576 481.791 574.209 480 572 480C569.791 480 568 481.791 568 484C568 486.209 569.791 488 572 488Z", lineId: "yellow", stationId: "picoas" })}
          {renderStationDot({ cx: 512, cy: 579, d: "M512 583C514.209 583 516 581.209 516 579C516 576.791 514.209 575 512 575C509.791 575 508 576.791 508 579C508 581.209 509.791 583 512 583Z", lineId: "yellow", stationId: "rato" })}
          {renderStationDot({ cx: 493, cy: 291, d: "M493 295C495.209 295 497 293.209 497 291C497 288.791 495.209 287 493 287C490.791 287 489 288.791 489 291C489 293.209 490.791 295 493 295Z", lineId: "green", stationId: "telheiras" })}
          {renderStationDot({ cx: 671, cy: 314, d: "M671 318C673.209 318 675 316.209 675 314C675 311.791 673.209 310 671 310C668.791 310 667 311.791 667 314C667 316.209 668.791 318 671 318Z", lineId: "green", stationId: "alvalade" })}
          {renderStationDot({ cx: 672, cy: 358, d: "M672 362C674.209 362 676 360.209 676 358C676 355.791 674.209 354 672 354C669.791 354 668 355.791 668 358C668 360.209 669.791 362 672 362Z", lineId: "green", stationId: "roma" })}
          {renderStationDot({ cx: 672, cy: 402, d: "M672 406C674.209 406 676 404.209 676 402C676 399.791 674.209 398 672 398C669.791 398 668 399.791 668 402C668 404.209 669.791 406 672 406Z", lineId: "green", stationId: "areeiro" })}
          {renderStationDot({ cx: 672, cy: 485, d: "M672 489C674.209 489 676 487.209 676 485C676 482.791 674.209 481 672 481C669.791 481 668 482.791 668 485C668 487.209 669.791 489 672 489Z", lineId: "green", stationId: "arroios" })}
          {renderStationDot({ cx: 672, cy: 513, d: "M672 517C674.209 517 676 515.209 676 513C676 510.791 674.209 509 672 509C669.791 509 668 510.791 668 513C668 515.209 669.791 517 672 517Z", lineId: "green", stationId: "anjos" })}
          {renderStationDot({ cx: 672, cy: 541, d: "M672 545C674.209 545 676 543.209 676 541C676 538.791 674.209 537 672 537C669.791 537 668 538.791 668 541C668 543.209 669.791 545 672 545Z", lineId: "green", stationId: "intendente" })}
          {renderStationDot({ cx: 672, cy: 569, d: "M672 573C674.209 573 676 571.209 676 569C676 566.791 674.209 565 672 565C669.791 565 668 566.791 668 569C668 571.209 669.791 573 672 573Z", lineId: "green", stationId: "martim-moniz" })}
          {renderStationDot({ cx: 672, cy: 597, d: "M672 601C674.209 601 676 599.209 676 597C676 594.791 674.209 593 672 593C669.791 593 668 594.791 668 597C668 599.209 669.791 601 672 601Z", lineId: "green", stationId: "rossio" })}
          {renderStationDot({ cx: 596, cy: 640, d: "M596 644C598.209 644 600 642.209 600 640C600 637.791 598.209 636 596 636C593.791 636 592 637.791 592 640C592 642.209 593.791 644 596 644Z", lineId: "green", stationId: "cais-sodre" })}
          {renderStationDot({ cx: 741, cy: 184, d: "M741 188C743.209 188 745 186.209 745 184C745 181.791 743.209 180 741 180C738.791 180 737 181.791 737 184C737 186.209 738.791 188 741 188Z", lineId: "red", stationId: "encarnacao" })}
          {renderStationDot({ cx: 665, cy: 184, d: "M665 188C667.209 188 669 186.209 669 184C669 181.791 667.209 180 665 180C662.791 180 661 181.791 661 184C661 186.209 662.791 188 665 188Z", lineId: "red", stationId: "aeroporto" })}
          {renderStationDot({ cx: 814, cy: 184, d: "M814 188C816.209 188 818 186.209 818 184C818 181.791 816.209 180 814 180C811.791 180 810 181.791 810 184C810 186.209 811.791 188 814 188Z", lineId: "red", stationId: "moscavide" })}
          {renderStationDot({ cx: 853, cy: 242, d: "M853 246C855.209 246 857 244.209 857 242C857 239.791 855.209 238 853 238C850.791 238 849 239.791 849 242C849 244.209 850.791 246 853 246Z", lineId: "red", stationId: "oriente" })}
          {renderStationDot({ cx: 840, cy: 296, d: "M840 300C842.209 300 844 298.209 844 296C844 293.791 842.209 292 840 292C837.791 292 836 293.791 836 296C836 298.209 837.791 300 840 300Z", lineId: "red", stationId: "cabo-ruivo" })}
          {renderStationDot({ cx: 819, cy: 329, d: "M819 333C821.209 333 823 331.209 823 329C823 326.791 821.209 325 819 325C816.791 325 815 326.791 815 329C815 331.209 816.791 333 819 333Z", lineId: "red", stationId: "olivais" })}
          {renderStationDot({ cx: 772, cy: 395, d: "M772 399C774.209 399 776 397.209 776 395C776 392.791 774.209 391 772 391C769.791 391 768 392.791 768 395C768 397.209 769.791 399 772 399Z", lineId: "red", stationId: "bela-vista" })}
          {renderStationDot({ cx: 748, cy: 429, d: "M748 433C750.209 433 752 431.209 752 429C752 426.791 750.209 425 748 425C745.791 425 744 426.791 744 429C744 431.209 745.791 433 748 433Z", lineId: "red", stationId: "olaias" })}
          {renderStationDot({ cx: 797, cy: 360, d: "M797 364C799.209 364 801 362.209 801 360C801 357.791 799.209 356 797 356C794.791 356 793 357.791 793 360C793 362.209 794.791 364 797 364Z", lineId: "red", stationId: "chelas" })}
            </G>
          </>
        ) : null}
        {showLabels ? (
          ...
          <G id="blue-line-titles">
            ...
            <Text id="Restauradores" fill="#1F2933" fontFamily={fontFamily} fontSize={10} fontWeight="510" letterSpacing="0em">
              <TSpan x="550" y="602.555">Restauradores</TSpan>
            </Text>
          ...
          <G id="green-line-titles">
            <Text id="Cais do Sodré" fill="#1F2933" fontFamily={fontFamily} fontSize={10} fontWeight="510" letterSpacing="0em">
              <TSpan x="517" y="644">Cais do Sodré</TSpan>
            </Text>
